...
//        e.g https://github.com/matthew-perry/web-server.git might become https://github.com/MyName/external.git
// variables:
//      roidtc-april2022-u410
...
//      https://github.com/matthew-perry/web-server.git
//      matperry
//      web-server-image
//      cluster-1
...
pipeline {
   ...
   environment {
        ...
        imageName = 'matperry/web-server-image'
        dockerImage = ''
        }
    stages {
        stage('Run the tests') {
            ...
            steps {
                ...
                git branch: 'main',
                    url: 'https://github.com/matthew-perry/web-server.git'
        ...
        stage('Building image') {
         ...
         stage('get k8s credentials') {
            ...
            steps {
                ...
                sh 'gcloud container clusters get-credentials cluster-1 --zone us-central1-c --project roidtc-april2022-u410'
            }
        }     
         stage('update k8s') {
             agent {
